  ...
  <div v-if="ptttList">
    <table class="table table-bordered">
      <tr>
        ...
        <th style="width: 30%;" class="text-center">Phẫu thuật/thủ thuật</th>
        <th style="width: 30%;" class="text-center">Bác sĩ thực hiện</th>
        <th style="width: 20%;" class="text-center">Ngày thực hiện</th>
      </tr>
      <tr v-for="(pttt, i) in ptttList" :key="pttt.id">
        ...
        <td class="text-center">{{ attr(pttt, "bacsithuchien.ten") }}</td>
        <td class="text-center">{{ pttt.ngaygiopttt }}</td>
      </tr>
      <tr v-if="ptttList.length==0">
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">
              <strong>Thông tin phẫu thuật thủ thuật</strong>
            </h5>
          ...
          <div v-if="pttt" class="modal-body">
            <TomTat :hsbaId="hsbaId" title="PHIẾU PHẪU THUẬT THỦ THUẬT"></TomTat>
            <hr />
            <div>
              <meta charset="UTF-8" />
              <table border="1" cellpadding="10" class="table table-bordered">
                <font size="2.5">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <b>
                        <span>Thông tin lược đồ phẫu thuật, thủ thuật</span>
                        <br />
                      </b>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <b>
                        <span>Thông tin trình tự phẫu thuật, thủ thuật</span>
                        <br />
                      </b>
                  ...
                  <table class="table table-bordered mt-3">
                    <tr>
                      ...
                      <th style="width:45%" class="text-center">Tên bác sĩ</th>
                      <th style="width:48%" class="text-center">Vai trò</th>
                    </tr>
                    <tr v-for="(tvpttt, i) in pttt.emrThanhVienPttts" :key="tvpttt.id">
                      <td>{{ i + 1}}</td>
                  ...
                  <div v-if="pttt.emrFileDinhKemPttts.length > 0">
                    ...
                    <table class="table table-bordered mt-3">
                      ...
                      <tr v-for="(file, i) in pttt.emrFileDinhKemPttts" :key="file.id">
                        <td>{{ i + 1 }}</td>
                        <td>
