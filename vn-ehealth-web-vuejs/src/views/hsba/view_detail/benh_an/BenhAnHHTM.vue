  ...
  <div class="container">
    <section class="container-fluid pt-2 mb-3">
      <div class="row">
        ...
        <div class="col-4">
          <h3 class="text-tle mt-3">BỆNH ÁN HUYẾT HỌC TRUYỀN MÁU</h3>
        </div>
        <div class="col-3">
          Số lưu trữ:
    ...
    <section class="container-fluid pt-2 mb-3">
      ...
      <div class="row mt-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Tinh thần của người bệnh: {{hsba.emrBenhAn.emrCkToanThan.tinhthan}}
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Hình dáng tư thế: {{hsba.emrBenhAn.emrCkToanThan.hinhdang}}
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Da, niêm mạc: {{hsba.emrBenhAn.emrCkToanThan.da}} {{hsba.emrBenhAn.emrCkToanThan.niemmac}}
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i> Triệu chứng xuất huyết
          <i>(mô tả chi tiết)</i>
          : {{hsba.emrBenhAn.emrCkToanThan.trieuchungxuathuyet}}
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Hệ thống lông, tóc, móng: {{hsba.emrBenhAn.emrCkToanThan.longtocmong}}
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Triệu chứng phù: {{hsba.emrBenhAn.emrCkToanThan.trieuchungphu}}
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Tuyến giáp: {{hsba.emrBenhAn.emrCkToanThan.tuyengiap}}
        </span>
      </div>
      ...
      <div class="row">
        <div class="col-6">
          <div class="row mt-2">
            <span class="ml-4">
              <i class="fas fa-fw bullet-small fa-circle"></i>
              Gan: Kích thước: {{hsba.emrBenhAn.emrCkToanThan.ganKichthuoc}}
            </span>
          </div>
          <ul>
            <dd>- Mật độ: {{hsba.emrBenhAn.emrCkToanThan.ganMatdo}}</dd>
            <dd>- Bờ: {{hsba.emrBenhAn.emrCkToanThan.ganBogan}}</dd>
            <dd>- Mặt gan:</dd>
            <dd>- Đau: {{hsba.emrBenhAn.emrCkToanThan.ganDau}}</dd>
          </ul>
          <div class="row mt-2">
            <span class="ml-4">
              <i class="fas fa-fw bullet-small fa-circle"></i>
              Lách: Kích thước: {{hsba.emrBenhAn.emrCkToanThan.lachKichthuoc}}
            </span>
          </div>
          <ul>
            <dd>- Mật độ: {{hsba.emrBenhAn.emrCkToanThan.lachMatdo}}</dd>
            <dd>- Bờ: {{hsba.emrBenhAn.emrCkToanThan.lachBolach}}</dd>
            <dd>- Mặt lach: {{hsba.emrBenhAn.emrCkToanThan.lachMatlach}}</dd>
            <dd>- Đau: {{hsba.emrBenhAn.emrCkToanThan.lachDaulach}}</dd>
          </ul>
          <div class="row mt-2">
            <span class="ml-4">
              <i class="fas fa-fw bullet-small fa-circle"></i> Hạch: Vị trí: ...
            </span>
          </div>
          <ul>
            <dd>- Kích thước : {{hsba.emrBenhAn.emrCkToanThan.hachKichthuoc}}</dd>
            <dd>- Số lượng : {{hsba.emrBenhAn.emrCkToanThan.hachSoluong}}</dd>
            <dd>- Độ di động: {{hsba.emrBenhAn.emrCkToanThan.hachDodidong}}</dd>
            <dd>- Đau: {{hsba.emrBenhAn.emrCkToanThan.hachDodauhach}}</dd>
          </ul>
        </div>
        <div class="col-6">
          <div class="row mt-2">
          ...
          <div class="row mt-2">
            <span class="ml-4">
              <i class="fas fa-fw bullet-small fa-circle"></i>
              Tim mạch: {{hsba.emrBenhAn.timmach}}
            </span>
          </div>
          <div class="row mt-2">
            <span class="ml-4">
          ...
          <div class="row mt-2">
            <span class="ml-4">
              <i class="fas fa-fw bullet-small fa-circle"></i>
              Tiêu hoá: {{hsba.emrBenhAn.tieuhoa}}
            </span>
          </div>
          <div class="row mt-2">
            <span class="ml-4">
              <i class="fas fa-fw bullet-small fa-circle"></i>
              Tiết niệu: {{hsba.emrBenhAn.tietnieu}}
            </span>
          </div>
          <div class="row mt-2">
            <span class="ml-4">
              <i class="fas fa-fw bullet-small fa-circle"></i> Khác: ....
            </span>
          </div>
        </div>
      </div>
      ...
      <div class="row mt-2">
        <table class="table table-bordered mt-3 ml-4 mr-4" style="width:80%">
          <tr>
            <th style="width:20%">Huyết học</th>
            <th style="width:10%" class="text-center"></th>
            <th style="width:20%">Truyền máu</th>
            <th style="width:10%" class="text-center"></th>
          </tr>
          <tr>
            <td>Huyết đồ</td>
          ...
          <tr>
            <td>Sinh thiết tuỷ</td>
            <td></td>
            <td>Kháng thể bất thường</td>
            <td></td>
          </tr>
          <tr>
            <td>Sinh thiết hạch</td>
            <td></td>
            <th>Các xét nghiệm liên quan:</th>
            <td></td>
          </tr>
          <tr>
            <td>Đông máu toàn bộ</td>
            <td></td>
            <td>Sinh hoá</td>
            <td></td>
          </tr>
          <tr>
            <td>Định lượng yếu tố đông máu</td>
            <td></td>
            <td>GPB</td>
            <td></td>
          </tr>
      ...
      <div class="row mt-2">
        <span class="ml-4">Các xét nghiệm khác .....</span>
      </div>
      ...
      <div class="row mt-2">
        <span class="ml-4">Truyền máu:</span>
      </div>

      <div class="row mt-2">
        <table class="ml-4 mr-4" style="width:80%">
          <tr>
            <td style="width:25%">1. Khối hồng cầu</td>
            <td style="width:10%">Số lần: 0</td>
            <td style="width:25%">5. Huyết tương:</td>
            <td style="width:10%">Số lần: 0</td>
          </tr>
          <tr>
            <td>2. Hồng cầu rửa</td>
            <td>Số lần: 0</td>
            <td>6. Huyết tương tươi đông lạnh:</td>
            <td>Số lần: 0</td>
          </tr>
          <tr>
            <td>3. Khối tiểu cầu</td>
            <td>Số lần: 0</td>
            <td>7. Tủa VIII:</td>
            <td>Số lần: 0</td>
          </tr>
          <tr>
            <td>4. Khối bạch cầu hạt</td>
            <td>Số lần: 0</td>
            <td>8. Truyền máu toàn phần:</td>
            <td>Số lần: 0</td>
          </tr>
        </table>
      </div>
      ...
      <div class="row mt-2">
        <span class="ml-4">
          Loại:
          <input type="checkbox" disabled class="ml-2 mr-2" />1. Mẩn ngứa
          <input type="checkbox" disabled class="ml-2 mr-2" />2. Sốt rét run
          <input type="checkbox" disabled class="ml-2 mr-2" />3. Choáng phản vệ
          <input type="checkbox" disabled class="ml-2 mr-2" /> 4.Khác
        </span>
      </div>
