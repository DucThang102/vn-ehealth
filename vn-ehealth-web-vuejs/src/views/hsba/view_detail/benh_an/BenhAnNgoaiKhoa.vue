  ...
  <div class="container">
    <section class="container-fluid pt-2 mb-3">
      <div class="row">
        ...
        <div class="col-4">
          <h3 class="text-tle mt-3">BỆNH ÁN NGOẠI KHOA</h3>
        </div>
        <div class="col-3">
          Số lưu trữ:
    ...
    <section class="container-fluid pt-2 mb-3">
      ...
      <div class="row mt-2">
        <div class="col-4">
          <span>
            <i class="fas fa-fw bullet-small fa-circle"></i> Phẫu thuật:
          </span>
        </div>
        <div class="col-4">
          <span>
            <i class="fas fa-fw bullet-small fa-circle"></i> Thủ thuật:
          </span>
        </div>
      </div>
