  ...
  <div class="container">
    <section class="container-fluid pt-2 mb-3">
      <div class="row">
        ...
        <div class="col-4">
          <h3 class="text-tle mt-3">BỆNH ÁN NHI KHOA</h3>
        </div>
        <div class="col-3">
          Số lưu trữ:
    ...
    <section class="container-fluid pt-2 mb-3">
      <section class="mb-4">
        ...
        <div class="row mb-2">
          <div class="col-4">
            <label>
              <b class="text-primary mr-1">7.</b>Họ tên bố:
            </label>
            <span>{{hsba.emrBenhNhan.hotenbo}}</span>
          </div>
          <div class="col-4">
            <label>Trình độ VH của bố:</label>
            <span>{{hsba.emrBenhNhan.trinhDoVanHoaCuaBo}}</span>
          </div>
          <div class="col-4">
            <label>Nghề nghiệp của bố:</label>
        ...
        <div class="row mb-2">
          <div class="col-4">
            <label class="ml-3">Họ tên mẹ:</label>
            <span>{{hsba.emrBenhNhan.hotenme}}</span>
          </div>
          <div class="col-4">
            <label>Trình độ VH của mẹ:</label>
            <span>{{hsba.emrBenhNhan.trinhDoVanHoaCuaMe}}</span>
          </div>
          <div class="col-4">
            <label>Nghề nghiệp của mẹ:</label>
        ...
        <div class="row mb-2">
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">11.</b>Vào viện:
                </label>
        ...
        <div class="row mb-2">
          ...
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">22.</b>Ra viện:
                </label>
              </div>
            </div>
        ...
        <div class="row mb-2">
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">23.</b>Kết quả điều trị:
                </label>
                <br />
                <div class="ml-3">
                  <input
            ...
            <div class="row">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">24.</b>Giải phẫu bệnh
          ...
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">25.</b>Tình hình tử vong:
                </label>
            ...
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">26.</b>Nguyên nhân chính tử vong:
                </label>
              </div>
            </div>
            ...
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">27.</b>Khám nghiệm tử thi:
                </label>
                <input
                  type="checkbox"
                  disabled
            ...
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">28.</b>Chẩn đoán giải phẫu tử thi:
                </label>
                <div class="col ml-3">
    ...
    <section class="container-fluid pt-2 mb-3">
      ...
      <div class="row mb-2">
        <div class="col-2">
          <span class="ml-2">
            <i class="fas fa-fw bullet-small fa-circle"></i> Là con thứ 1
          </span>
        </div>
        <div class="col-10">
          <span class="ml-4">
            <i class="fas fa-fw bullet-small fa-circle"></i> Tiền thai (Para):
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTienSuSanKhoa.paraDuthang') "
              type="checkbox"
            />
            ...
            <input
              ...
              type="checkbox"
            />
            <span class="mr-3">Sớm (đẻ non)</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTienSuSanKhoa.paraDuthang') "
              type="checkbox"
 ...
 Tình trạng khi sinh:
      ...
      <div class="row mb-2">
        <div class="col-3">
          <input
            disabled
            :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.dethuong')"
            type="checkbox"
          />
      ...
      <div class="row mb-2">
        <div class="col-3">
          <input
            disabled
            :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.forceps') "
            type="checkbox"
          />
          <span class="mr-3">2.Forceps</span>
        </div>
        <div class="col-3">
          <input
            disabled
            :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.giachut') "
            type="checkbox"
          />
          <span class="mr-3">3.Giác hút</span>
        </div>
        <div class="col-3">
          <input
            disabled
            :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.dephauthuat')  "
            type="checkbox"
          />
          <span class="mr-3">4.Đẻ phẫu thuật</span>
        </div>

        <div class="col-3">
          <input
            disabled
            :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.dechihuy') "
            type="checkbox"
          />
          <span class="mr-3">5.Đẻ chỉ huy</span>
        </div>
      </div>
      <div class="row mb-2">
        <div class="col-3">
          <input
            disabled
            :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.dekhac') "
            type="checkbox"
          />
          <span class="mr-3">6.Khác</span>
        </div>
      </div>
      ...
      <div class="row mb-2">
        <div class="col-3">
          <span class="ml-2">
            <i class="fas fa-fw bullet-small fa-circle"></i>
            Cân nặng lúc sinh: {{ hsba.emrBenhAn.emrCkQuaTrinhSinhTruong.cannangsinh }} kg
          </span>
        </div>
        <div class="col-3">
          <input
            disabled
            :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.coditat') "
            type="checkbox"
          />
          <span class="ml-2">Dị tật bẩm sinh</span>
        </div>
        <div class="col-6">
          <span class="ml-2">Cụ thể dị tật bẩm sinh:</span>
          <span>{{hsba.emrBenhAn.emrCkQuaTrinhSinhTruong.motaditat}}</span>
        </div>
      </div>
      <div class="row mb-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Phát triển về tinh thần:{{hsba.emrBenhAn.emrCkQuaTrinhSinhTruong.phattrientinhthan}}
        </span>
      </div>
      ...
      <div class="row mb-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Phát triển về vận động:{{hsba.emrBenhAn.emrCkQuaTrinhSinhTruong.phattrienvandong}}
        </span>
      </div>
      ...
      <div class="row mb-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Các bệnh lý khác: {{hsba.emrBenhAn.emrCkQuaTrinhSinhTruong.benhlykhac}}
        </span>
      </div>
      ...
      <div class="row mb-2">
        <div class="col-8">
          <span class="ml-2">
            <i class="fas fa-fw bullet-small fa-circle"></i> Nuôi dưỡng:
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.suame')"
              type="checkbox"
            />
            <span class="mr-3">1. Sữa mẹ</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.suangoai')"
              type="checkbox"
            />
            <span class="mr-3">2. Nuôi nhân tạo</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.honhop')"
              type="checkbox"
            />
            <span class="mr-3">3. Hỗn hợp</span>
          </span>
        </div>
        <div class="col-4">
          <span class="ml-2">
            <i class="fas fa-fw bullet-small fa-circle"></i>
            Cai sữa tháng thứ: {{hsba.emrBenhAn.emrCkQuaTrinhSinhTruong.thangcaisua}}
          </span>
        </div>
      </div>
      ...
      <div class="row mb-2">
        <div class="col-6">
          <span class="ml-2">
            <i class="fas fa-fw bullet-small fa-circle"></i> Chăm sóc:
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.vuontre') "
              type="checkbox"
            />
            <span class="mr-3">1. Tại vườn trẻ</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkQuaTrinhSinhTruong.tainha') "
              type="checkbox"
            />
            <span class="mr-3">2. Tại nhà</span>
          </span>
        </div>
      </div>
      ...
      <div class="row mb-2">
        <div class="col-12">
          <span class="ml-2">
            <i class="fas fa-fw bullet-small fa-circle"></i> Đã tiêm chủng:
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTiemChung.tclao') "
              type="checkbox"
            />
            <span class="mr-3">1. Lao</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTiemChung.tcbailiet')"
              type="checkbox"
            />
            <span class="mr-3">2.Bại liệt</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTiemChung.tcsoi') "
              type="checkbox"
            />
            <span class="mr-3">3.Sởi</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTiemChung.tchoga')"
              type="checkbox"
            />
            <span class="mr-3">4.Ho gà</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTiemChung.tcuonvan')"
              type="checkbox"
            />
            <span class="mr-3">5.Uốn ván</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTiemChung.tcbachhau')"
              type="checkbox"
            />
            <span class="mr-3">6.Bạch hầu</span>
            <input
              disabled
              :checked="attr(hsba, 'emrBenhAn.emrCkTiemChung.tckhac')"
              type="checkbox"
            />
            <span class="mr-3">7.Tiêm chủng khác</span>
          </span>
        </div>
      </div>
      ...
      <div class="row mb-2">
        <span class="ml-4">
          <i class="fas fa-fw bullet-small fa-circle"></i>
          Cụ thể những bệnh khác được tiêm chủng:{{hsba.emrBenhAn.emrCkTiemChung.tcmotakhac}}
        </span>
      </div>
      ...
      <div class="row-mt-2">
        <ul>
          ...
          <li>Thận- Tiết niệu- Sinh dục: {{hsba.emrBenhAn.noitietsinhduc}}</li>
          ...
          <li>Răng- Hàm- Mặt: {{hsba.emrBenhAn.tuanhoan}}</li>
          <li>Mắt: {{hsba.emrBenhAn.mat}}</li>
          <li>Nội tiết, dinh dưỡng và các bệnh lý khác: {{hsba.emrBenhAn.noitietdinhduong}}</li>
        </ul>
      </div>
