  ...
  <div class="container">
    <section class="container-fluid pt-2 mb-3">
      <div class="row">
        ...
        <div class="col-4">
          <h3 class="text-tle mt-3">BỆNH ÁN DA LIỄU</h3>
        </div>
        <div class="col-3">
          Số lưu trữ:
    ...
    <section class="container-fluid pt-2 mb-3">
      ...
      <div class="row mt-2">
        <span>
          <b>2. Triệu chứng cơ năng:</b>
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">Triệu chứng .....</span>
      </div>

      <div class="row mt-2">
        <span>
          <b>3. Thương tổn căn bản:</b>
          <i>(sơ phát, thứ phát, tính chất, loại phân bố, kích thước, hình dáng, mầu sắc vv...)</i>
        </span>
      </div>
      <div class="row mt-2">
        <span class="ml-4">Tổn thương .....</span>
      </div>
      ...
      <div class="row-mt-2">
        <ul>
          ...
          <li>Thần Kinh ngoại biên:{{hsba.emrBenhAn.thankinh}}</li>
          <li>Cơ quan khác:{{hsba.emrBenhAn.tuanhoan}}</li>
        </ul>
      </div>

      <div class="row mt-2">
        <span>
          <b>5. Các xét nghiệm cận lâm sàng cần làm:</b>
        </span>
      </div>
