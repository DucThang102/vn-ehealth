  ...
  <div class="container">
    <section class="container-fluid pt-2 mb-3">
      <div class="row">
        ...
        <div class="col-4">
          <h3 class="text-tle mt-3">BỆNH ÁN RĂNG HÀM MẶT</h3>
        </div>
        <div class="col-3">
          Số lưu trữ:
        ...
        <div class="row mb-2">
          <div class="col-6">
            ...
            <div class="row">
              <div class="col">
                <div class="ml-3">
                  <input disabled :checked="(hsba, 'coPhauThuat')" type="checkbox" />
                  <span class="mr-3">Tai biến</span>
                  <input disabled :checked="(hsba, 'coThuThuat')" type="checkbox" />
                  <span class="mr-3">Biến chứng</span>
                </div>
                <div class="ml-3">
                  <input disabled type="checkbox" />
                  <span class="mr-3">1.Do phẫu thuật</span>
                  <br />
                  <input disabled type="checkbox" />
                  <span class="mr-3">2.Do gây mê</span>
                  <br />
                  <input disabled type="checkbox" />
                  <span class="mr-3">3.Do nhiễm khuẩn</span>
                  <br />
                  <input disabled type="checkbox" />
                  <span class="mr-3">4.Khác</span>
                </div>
            ...
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">23.</b>Tổng số ngày điều trị sau phẫu thuật:
                </label>
              </div>
            </div>
            <div class="row mb-2">
              <div class="col">
                <span>{{hsba.emrChanDoan.tongsongaysaupt}}</span>
                <form class="form-inline input-lr2 float-right">
                  <input
                    readonly
                    value="0"
            ...
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">24.</b>Tổng số lần phẫu thuật
                </label>
              </div>
            </div>
            ...
            <div class="row mb-2">
              <div class="col">
                <span>{{hsba.emrChanDoan.tongsolanpt}}</span>
                <form class="form-inline input-lr2 float-right">
                  <input
                    readonly
                    value="0"
          ...
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">25.</b>Ra viện:
                </label>
              </div>
            </div>
            ...
            <div class="row mb-2">
              <div class="col ml-4">
                <label>
                  <i>(nguyên nhân):</i>
                  {{hsba.emrChanDoan.emrDmMaBenhChandoanraviennguyennhan.ten}}
                </label>
                <br />
                <form class="form-inline input-lr2 float-right">
                  <input
            ...
            <div class="row mb-2">
              <div class="col ml-4">
                ...
                <br />
                <span>{{hsba.emrChanDoan.motachandoantruocpt}}</span>
                <form class="form-inline input-lr2 float-right">
                  <input
                    readonly
                    value="0"
            ...
            <div class="row mb-2">
              <div class="col ml-4">
                ...
                <br />
                <span>{{hsba.emrChanDoan.motachandoansaupt}}</span>
                <form class="form-inline input-lr2 float-right">
                  <input
                    readonly
                    value="0"
        ...
        <div class="row mb-2">
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">26.</b>Kết quả điều trị:
                </label>
                <br />
                <div class="ml-3">
                  <input
            ...
            <div class="row">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">27.</b>Giải phẫu bệnh
          ...
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">28.</b>Tình hình tử vong:
                </label>
              ...
              <div class="col">
                <div class="ml-3">
                  ...
                  <input
                    ...
                    type="checkbox"
                  />
                  <span class="mr-3">2.Trong 48 giờ vào viện</span>
                  <br />
                  <input
                    disabled
                    :checked="attr(hsba, 'emrTinhTrangRaVien.emrDmThoiDiemTuVong.ma') == '03' "
                    type="checkbox"
                  />
                  <span class="mr-3">3.Trong 72 giờ vào viện</span>
                </div>
              </div>
            </div>
            ...
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">29.</b>Nguyên nhân chính tử vong:
                </label>
              </div>
            </div>
        ...
        <div class="row mb-2">
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">30.</b>Khám nghiệm tử thi:
                </label>
                <input
          ...
          <div class="col-6">
            <div class="row mb-2">
              <div class="col">
                <label>
                  <b class="text-primary mr-1">31.</b>Chẩn đoán giải phẫu tử thi:
                </label>
                <div class="col ml-3">
    ...
    <section class="container-fluid pt-2 mb-3">
      ...
      <div class="row mt-2">
        <span>
          <b>Hình vẽ mô tả tổn thương khi vào viện</b>:
        </span>
      </div>
      ...
      <div class="row mt-2">
        <table class="table ml-4">
          ...
          <tr>
            ...
            <td>Thẳng</td>
            <td>Trái</td>
            <td>Hàm trên và Họng</td>
            <td>Hàm dưới</td>
            <td>Phân loại khe hở môi vòm miệng</td>
          </tr>
        </table>
      </div>
