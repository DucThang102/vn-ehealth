...
VueAsyncComponent(
  "hoichan-list",
  "/pages/hsba/view_detail/hoichan/hoichan_list.html",
  {
    data: function() {
      return {
        hoichan_list: null,
    ...
    created: async function() {
      if (this.hsba_id) {
        ...
        this.hoichan_list = await this.get("/api/hoichan/get_ds_hoichan", {
          hsba_id: this.hsba_id
        });
        console.log(this.hoichan_list);
      }
    }
  }
);
...
VueAsyncComponent(
  "hoichan-view",
  "/pages/hsba/view_detail/hoichan/hoichan_view.html",
  {
    data: function() {
      return {
        hsba: null
