...
VueAsyncComponent(
  "chamsoc-list",
  "/pages/hsba/view_detail/chamsoc/chamsoc_list.html",
  {
    data: function() {
      return {
        chamsoc_list: null,
    ...
    created: async function() {
      if (this.hsba_id) {
        ...
        this.chamsoc_list = await this.get("/api/chamsoc/get_ds_chamsoc", {
          hsba_id: this.hsba_id
        });
        console.log(this.chamsoc_list);
...
VueAsyncComponent(
  "chamsoc-view",
  "/pages/hsba/view_detail/chamsoc/chamsoc_view.html",
  {
    data: function() {
      return {
        hsba: null
