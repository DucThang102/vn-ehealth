...
public class EmrChanDoanHinhAnh {
    ...
    @Transient public List<EmrFileDinhKem> emrFileDinhKemCdhas = new ArrayList<>();
    ...
    public List<EmrFileDinhKem> getEmrQuanLyFileDinhKemCdha() {
        return emrFileDinhKemCdhas;
    }
