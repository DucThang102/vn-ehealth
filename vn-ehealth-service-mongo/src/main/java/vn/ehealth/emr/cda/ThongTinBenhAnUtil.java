...
public class ThongTinBenhAnUtil {
    ...
    public static void addHistoryAndPhysicalNote(HsbaDocument doc, EmrHoSoBenhAn emrDanhSachHoSoBenhAn, Map<String, String> emrParameters, Properties properties, String srcLocalFolder) throws IOException{
    ...
    public static void addPqObservationValueTag(Observation obs, String unit, double value){
    ...
    public static void addVitalSignsSection(HsbaHistoryAndPhysicalNoteSection historyAndPhysicalNoteSection, EmrBenhAn emrBenhAn, String sectionContentDelimiter, String splitDelimiter, Properties properties){
        ...
        if(emrBenhAn.mach != null){
            addPqObservationValueTag(heartRateObs, machUnit, emrBenhAn.mach);
            vitalSignsText.append(properties.getProperty("BA_DHST_MACH_TITLE", "BA_DHST_MACH_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.mach).append(machUnit).append(splitDelimiter);
        }
        ...
        if(emrBenhAn.nhietdo != null){
            addPqObservationValueTag(bodyTemperatureObs, nhietDoUnit, emrBenhAn.nhietdo);
            vitalSignsText.append(properties.getProperty("BA_DHST_NHIETDO_TITLE", "BA_DHST_NHIETDO_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.nhietdo).append(nhietDoUnit).append(splitDelimiter);
        }
        ...
        if(emrBenhAn.huyetapcao != null) {
            addPqObservationValueTag(bpSystolicObs, huyetApUnit, (int) emrBenhAn.huyetapcao);
        }
        ...
        if(emrBenhAn.huyetapthap != null) {
            addPqObservationValueTag(bpDiastolicObs, huyetApUnit, emrBenhAn.huyetapthap);
        }
        if(emrBenhAn.huyetapcao != null && emrBenhAn.huyetapthap != null){
            vitalSignsText.append(properties.getProperty("BA_DHST_HUYETAP_TITLE", "BA_DHST_HUYETAP_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.huyetapcao)
                      .append(properties.getProperty("VITALSIGNS_BP_SPLIT", "VITALSIGNS_BP_SPLIT")).append(emrBenhAn.huyetapthap).append(huyetApUnit).append(splitDelimiter);
        }
        ...
        if(emrBenhAn.nhiptho != null){
            addPqObservationValueTag(respiratoryRateObs, nhipThoUnit, emrBenhAn.nhiptho);
            vitalSignsText.append(properties.getProperty("BA_DHST_NHIPTHO_TITLE", "BA_DHST_NHIPTHO_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.nhiptho).append(nhipThoUnit).append(splitDelimiter);
        }
        ...
        if(emrBenhAn.cannang != null){
            addPqObservationValueTag(weightMeasuredObs, canNangUnit, emrBenhAn.cannang);
            vitalSignsText.append(properties.getProperty("BA_DHST_CANNANG_TITLE", "BA_DHST_CANNANG_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.cannang).append(canNangUnit).append(splitDelimiter);
        }
        ...
        if(emrBenhAn.vongdau != null){
            addPqObservationValueTag(headCircumferenceObs, chuViDauUnit, emrBenhAn.vongdau);
            vitalSignsText.append(properties.getProperty("BA_DHST_CHUVIDAU_TITLE", "BA_DHST_CHUVIDAU_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.vongdau).append(chuViDauUnit).append(splitDelimiter);
        }
        ...
        if(emrBenhAn.chieucao != null){
            addPqObservationValueTag(heightObs, chieucaoUnit, emrBenhAn.chieucao);
            vitalSignsText.append(properties.getProperty("BA_DHST_CHIEUCAO_TITLE", "BA_DHST_CHIEUCAO_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.chieucao).append(chieucaoUnit).append(splitDelimiter);
        }
        ...
        if(emrBenhAn.vongnguc != null){
            addPqObservationValueTag(breastsObs, vongngucUnit, emrBenhAn.vongnguc);
            vitalSignsText.append(properties.getProperty("BA_DHST_VONGNGUC_TITLE", "BA_DHST_VONGNGUC_TITLE")).append(sectionContentDelimiter).append(emrBenhAn.vongnguc).append(vongngucUnit).append(splitDelimiter);
        }
    ...
    public static void addInjuryObservationMedia(HsbaInjuryIncidentDescriptionSection injurySection, EmrHinhAnhTonThuong hinhAnh, StringBuilder injuryIncidentDescText, Properties properties, String srcLocalFolder) throws IOException{
