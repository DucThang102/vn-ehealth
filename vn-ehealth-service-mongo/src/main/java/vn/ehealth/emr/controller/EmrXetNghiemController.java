...
public class EmrXetNghiemController {
    ...
    @GetMapping("/get_ds_xetnghiem_by_bn_new")
    public ResponseEntity<?> getDsXetNghiemByBenhNhanNew(@RequestParam("benhnhan_id") String benhNhanId, @RequestParam int start, @RequestParam int count) {
